...
#ifndef __GST_NVMM_CONVERT_H__
#define __GST_NVMM_CONVERT_H__
...
#define GST_NVMM_CONVERT_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS((obj), GST_TYPE_NVMM_CONVERT,GstNvmmConvertClass))
